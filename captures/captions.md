...
| `02b-agent-card-a2a.webp` | L'Agent Card A2A (`/.well-known/agent-card.json`) : nom, description, skills, URL — ce que les autres agents découvrent pour dialoguer avec lui. | The A2A Agent Card (`/.well-known/agent-card.json`): name, description, skills, URL — what other agents discover in order to talk to it. |
